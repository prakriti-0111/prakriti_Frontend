...
const mapStateToProps = (state) => ({
    items: state.customer.address.items,
    total: state.customer.address.total,
    actionCalled: state.customer.address.actionCalled,
    createSuccess: state.customer.address.createSuccess,
    editSuccess: state.customer.address.editSuccess,
    deleteSuccess: state.customer.address.deleteSuccess,
    successMessage: state.customer.address.successMessage,
    errorMessage: state.customer.address.errorMessage
});
