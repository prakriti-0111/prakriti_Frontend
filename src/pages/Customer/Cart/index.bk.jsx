                        ...
                        <div className="cart-inner-wrapper" key={index}>
                              ...
                              <div>
                                <div className="cart-image-title">
                                  ...
                                  <p>
                                    Product Code :{" "}
                                    <span>
                                      {val.product_id || 289828490189210}
                                    </span>
                                  </p>
                                </div>
                                ...
                                <p className="p-variant">
                                  Stone:{" "}
                                  <span> 37 Diamond, 0.2380 Carat, SI IJ </span>
                                </p>
                                <div className="cart-icons">
                                  <h4 onClick={() => onRemove(val.id)} className="text-bg-danger">
                                    {" "}
                                    <MdOutlineDelete /> <i class="bi bi-trash3 me-2"></i> Remove
                                  </h4>
                          ...
                          >
                            <ul>
                              ...
                              <li>
                                <HiCheckCircle /> Eligible for Lifetime exchange
                                & Buy back
                              </li>
                              <li>
              ...
              <Col xs={12} md={4}>
                <div className="cart-right-sidebar">
                  ...
                  <div className="summary-items">
                    <p>
                      Total ( <span>{cartLength} </span> Items )
                    </p>
                    <p>₹13999</p>
                  </div>
                  ...
                  <p className="queries">
                    <span>Any Questions?</span> Please call us at 1800-419-0066
                    or Chat with us
                  </p>
                </div>
              </Col>
