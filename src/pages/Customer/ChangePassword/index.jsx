...
import { CUSTOMER_RESET_CHANGE_PASSWORD } from 'actionTypes/Customer/changePassword.types';
...
class ChangePassword extends React.Component {
    ...
    p_formValidate = () => {
        ...
        if(formValues.new_password && formValues.new_password.length < 8){
            formErros.new_password = true;
            hasErr = true;
            toast.error('Password must be at least 8 characters.');
        }else if(formValues.new_password && formValues.confirm_password && formValues.new_password !== formValues.confirm_password){
            formErros.confirm_password = true;
            hasErr = true;
    ...
    componentDidUpdate(prevProps){
        if(this.state.ch_actionCalled){
            ...
            this.props.dispatch({
                type: CUSTOMER_RESET_CHANGE_PASSWORD
            });
        }
    }
...
const mapStateToProps = (state) => ({
    ch_actionCalled: state.customer.changePassword.actionCalled,
    changePasswordSuccess: state.customer.changePassword.changePasswordSuccess,
    ch_successMessage: state.customer.changePassword.successMessage,
    ch_errorMessage: state.customer.changePassword.errorMessage,
});
