...
class ProductsPage extends React.Component {
  ...
  handleSubcategory = (slug) => {
    ...
    this.props.navigate("/products" + objectToQuery(params, true));
  };
    ...
    return (
      <div className="search-wrapper category-listing-wrapper">
        ...
        <Container>
          ...
          {/* Banner + search/sort-filter bar kept sticky below the fixed header */}
          ...
          <div className="mobile-dropdown">
            <div className="mobile-dropdown-wrapper">
              ...
              {this.getSubCategories().length > 0 && (
                <Dropdown className="subcategory-filter">
                  <Dropdown.Toggle
                    variant="primary"
                    id="dropdown-subcategory-mobile"
                    className="filter-icon"
                  >
                    {this.getSelectedSubcategoryName() || "Subcategory"}{" "}
                    <BsFilterLeft />
