...
import { CUSTOMER_RESET_PROFILE } from 'actionTypes/Customer/profile.types';
        ...
        return (
            <div className='edit-profile-wrapper'>
                ...
                <div className='edit-inner'>
                    ...
                    <div className='edit-profile-picture position-relative mt-3 mt-md-0' style={{backgroundImage : `url(${profile.formValues.imageUrl})`}}>
...
const mapStateToProps = (state) => ({
    ...
    new_image_url: state.customer.profile.image_url
});
