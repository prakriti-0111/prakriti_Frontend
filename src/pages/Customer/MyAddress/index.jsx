...
import { AddressUpdate, AddressList, AddressDelete, AddressCreate } from "actions/Customer/address.actions";
...
const mapStateToProps = (state) => ({
    addressList: state.customer.address.items,
    addressListTotal: state.customer.address.total,
