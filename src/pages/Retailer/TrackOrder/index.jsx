                    ...
                    <div className='vertical timeline'>
                        <div className='steps'>
                            <div className='step'>
                                ...
                                <div><h1>Order Awaiting for  Approval<span className='timer'> <FcAlarmClock /> Usually takes 30-40 mins</span></h1> <h3>2 July 2022</h3></div>
                ...
                <Container>
                    ...
                    <div className='vertical timeline'>
                        <div className='steps'>
                            <div className='step'>
                                <span className='icon'><BiShoppingBag /></span>
                                <div><div className='line-heading mb-3'>Order Awaiting Approval <h3 className='mb-3'>2 July 2022</h3><span className='timer'> <FcAlarmClock /> Usually takes 30-40 mins</span></div> </div>
