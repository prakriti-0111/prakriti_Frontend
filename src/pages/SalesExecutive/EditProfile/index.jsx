...
import { ProfileUpdate } from "actions/Sales/profile.actions"
import { toast } from 'react-toastify';
import { SALES_RESET_PROFILE } from 'actionTypes/Sales/profile.types';
...
const mapStateToProps = (state) => ({
    auth: state.auth,
    p_actionCalled: state.sales.profile.actionCalled,
    editProfileSuccess: state.sales.profile.editProfileSuccess,
    p_successMessage: state.sales.profile.successMessage,
    p_errorMessage: state.sales.profile.errorMessage,
    new_image_url: state.sales.profile.image_url
});
