...
import { productList } from "actions/Sales/product.actions";
import { categoryList } from "actions/Sales/categories.actions";
import { AddToCart, CartList } from "actions/Sales/addcart.actions";
import { WishListAdd, WishListData } from "actions/Sales/wishlist.actions"
...
const SearchResult = (props) => {
    ...
    const onProductMove = (id) => {
        ...
        setLoad(true)
        window.location.href = `/sales-executive/product-details/${id}`
    }
    useEffect(() => {
