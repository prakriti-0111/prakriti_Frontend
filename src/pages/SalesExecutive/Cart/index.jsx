...
import { CartList, CartDelete } from "actions/Sales/addcart.actions";
...
class CartPage extends React.Component {
  ...
  handlePlaceOrder = () => {
    this.props.navigate("/sales-executive/checkout");
  };
                        ...
                        <div>
                          <div className="cart-inner-wrapper" key={index}>
                              ...
                              <div className="cart-image-content">
                                <div>
                                  ...
                                  <div className="cart-icons mt-3">
                                    <h4 onClick={() => this.removeConfirm(val)}>
                                      {" "}
                            ...
                            {index == cartList.length - 1 ? (
                              <div
                                className="cart-notes mt-4"
                                style={{ width: "100%", bottom: "300px" }}
                              >
                                <ul>
                                  <li>
                                    <HiCheckCircle /> 30 Day Money Back
                                  </li>
                                  <li>
                                    <HiCheckCircle /> Eligible for Lifetime
                                    exchange & Buy back
                                  </li>
                                  <li>
                                    <HiCheckCircle /> FREE & Insured Delivery
                                  </li>
                                </ul>
                              </div>
                            ) : null}
                  ...
                  <div className="cart-right-sidebar">
                    ...
                    {cartList.length ? (
                      <>
                        ...
                        <p className="queries">
                          <span>Any Questions?</span> Please call us at
                          1800-419-0066 or Chat with us
                        </p>
                      </>
                    ) : null}
                  </div>
...
const mapStateToProps = (state) => ({
  ...
  actionCalled: state.sales.cart.actionCalled,
  deleteSuccess: state.sales.cart.deleteSuccess,
  successMessage: state.sales.cart.successMessage,
  errorMessage: state.sales.cart.errorMessage,
});
