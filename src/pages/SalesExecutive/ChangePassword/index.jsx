...
import { changePassword } from "actions/Sales/changePassword.actions";
...
class ChangePassword extends React.Component {
    ...
    componentDidUpdate(prevProps){
        if(this.state.ch_actionCalled){
            ...
            this.props.dispatch({
                type: SALES_RESET_CHANGE_PASSWORD
            });
        }
    }
...
const mapStateToProps = (state) => ({
    ch_actionCalled: state.sales.changePassword.actionCalled,
    changePasswordSuccess: state.sales.changePassword.changePasswordSuccess,
    ch_successMessage: state.sales.changePassword.successMessage,
    ch_errorMessage: state.sales.changePassword.errorMessage,
});
