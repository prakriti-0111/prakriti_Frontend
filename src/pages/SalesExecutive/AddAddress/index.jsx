...
const AddAddress = (props) => {
    const address = useSelector((state) => state.sales.address)
...
const mapStateToProps = (state) => ({
    items: state.sales.address.items,
    total: state.sales.address.total,
    actionCalled: state.sales.address.actionCalled,
    createSuccess: state.sales.address.createSuccess,
    editSuccess: state.sales.address.editSuccess,
    deleteSuccess: state.sales.address.deleteSuccess,
    successMessage: state.sales.address.successMessage,
    errorMessage: state.sales.address.errorMessage
});
